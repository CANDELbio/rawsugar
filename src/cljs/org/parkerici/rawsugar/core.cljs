(ns ^:figwheel-hooks org.parkerici.rawsugar.core
  (:require
   [reagent.dom :as rdom]
   [re-frame.core :as rf]
   [org.parkerici.multitool.core :as u]
   [org.parkerici.rawsugar.asof :as asof]
   [org.parkerici.rawsugar.navigate :as nav]
   [org.parkerici.rawsugar.flash :as flash]
   [org.parkerici.rawsugar.modal :as modal]
   ...
   [org.parkerici.rawsugar.cnavigate :as cnav]
   [org.parkerici.rawsugar.ops :as ops]
   org.parkerici.rawsugar.entity
  ...
  [:li.nav-item.dropdown
   ...
   [:div.dropdown-menu {:aria-labelledby "navbarHelp"}
    ...
    [:a.dropdown-item (assoc (non-spa-nav "/user-guide") :target "_guide")
     "User Guide"]
    [:a.dropdown-item {:href "https://dataplatform.parkerici.org" :target "_guide"}
     "Data Platform"]
    [:a.dropdown-item {:href "https://github.com/ParkerICI/rawsugar/releases/latest" :target "_github"}
     "Download CLI"]
    [:a.dropdown-item {:href "https://github.com/ParkerICI/rawsugar/issues/new" :target "_github"}
     "Report an issue"]
    [:a.dropdown-item {:href "https://github.com/ParkerICI/rawsugar" :target "_guide"}
     "Github"]
    ]])
