(ns org.parkerici.rawsugar.batch
  (:require [re-frame.core :as rf]
            [oz.core :as oz]
            [org.parkerici.multitool.core :as u]
            [org.parkerici.rawsugar.navigate :as nav]
            [org.parkerici.rawsugar.recipe :as recipe]
            ...
            [org.parkerici.rawsugar.utils :as ru]
...
(defn set-datatype
  ...
  ;; ugly
  (rf/dispatch [:eval
                `(org.parkerici.rawsugar.recipes/instantiate-recipe ~(:db/id batch) ~new-dt)
