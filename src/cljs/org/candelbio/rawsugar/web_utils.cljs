(ns org.candelbio.rawsugar.web-utils
...
;;; TODO use re-com icon-buttons where appropriate https://re-com.day8.com.au/#/md-icon-button
...
;;; TODO option for allowing prompt=nil to be selectable (use for sheet picker, 
(defn select-widget
