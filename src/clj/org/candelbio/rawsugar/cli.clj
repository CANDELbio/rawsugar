(ns org.candelbio.rawsugar.cli
  ...
  (:require [clojure.set :as set]
            ...
            [org.candelbio.rawsugar.glue.cellengine :as ce]
...
(defn usage
  ...
  (->> [""
        ...
        ""
        ;; TODO opensource 
        "See user documentation at https://github.com/Candelbio/rawsugar/blob/master/doc/user-guide.org"
        ""
        "Options:"
        options-summary]
       (str/join \newline)))
